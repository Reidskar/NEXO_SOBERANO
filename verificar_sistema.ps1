...
try {
    $health = Invoke-RestMethod -Uri 'http://localhost:8080/api/health' -Headers $headers -TimeoutSec 5
...
try {
    $evo = Invoke-RestMethod -Uri 'http://localhost:8080/api/ai/evolution-status' -Headers $headers -TimeoutSec 5
...
try {
    $response = Invoke-WebRequest -Uri 'http://localhost:8080/control-center' -TimeoutSec 5 -UseBasicParsing
...
Write-Host "═══════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
Write-Host "  1. Abre: http://localhost:8080/control-center" -ForegroundColor White
